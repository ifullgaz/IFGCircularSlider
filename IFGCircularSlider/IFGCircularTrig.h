 ...
 */
@interface IFGCircularTrig : NSObject
 ...
 *  @param fromPoint   Point on the circle circumference
 *  @param toPoint     Point on the circle circumference
 *  @param northOffset The position of the north in degrees
 *
 *  @return Angle in degrees between the two points, relative to North as northOffset degrees (clockwise)
 */
+ (CGFloat)angleRelativeToNorthFromPoint:(CGPoint)fromPoint
                                 toPoint:(CGPoint)toPoint
